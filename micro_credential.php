...
// Fetch Micro-Credential programmes with first image
$stmt = $conn->prepare("SELECT p.programme_id, p.title, p.description, p.start_date, p.end_date, p.location, p.price, p.has_packages,
                        ...
                        FROM programmes p
                        WHERE p.programme_category = 'micro_credential' AND p.is_active = 1 
...
<head>
    ...
    <title>Micro-Credential — ACE</title>
    ...
    <style>
        ...
        .page-header { background: linear-gradient(135deg, #fd7e14 0%, #dc6502 100%); color:#fff; padding:48px 0; }
        ...
        .programme-badge { background: rgba(253,126,20,0.12); color: #fd7e14; font-weight:600; }
    </style>
</head>
<body>
...
<section class="page-header">
    <div class="container">
        <h1 class="display-5 mb-3">🎖️ Micro-Credential Programmes</h1>
        <p class="lead mb-0">Tailored micro-credentials for focused skill development and professional advancement.</p>
    </div>
</section>
...
<section class="container mt-3">
    <div class="alert alert-info">
        Can't find the Micro-Credential you need? <a href="service_inquiry.php?service=micro_credential" class="alert-link">Request a Micro-Credential</a> and we'll assist you.
    </div>
</section>
...
<section class="py-5">
    <div class="container">
        ...
        <div class="alert alert-info text-center">
            ...
            No micro-credential programmes available at the moment. Please check back later.
        </div>
        <?php else: ?>
            ...
            <div class="programme-row d-flex align-items-stretch mb-3 p-0 overflow-hidden">
                ...
                <div class="flex-grow-1 p-4">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            <span class="badge programme-badge mb-2">Micro-Credential</span>
