...
// Fetch certificate programmes with first image
$stmt = $conn->prepare("SELECT p.programme_id, p.title, p.description, p.start_date, p.end_date, p.location, p.price, p.has_packages,
                        ...
                        FROM programmes p
                        WHERE p.programme_category = 'certificate' AND p.is_active = 1 
...
<head>
    ...
    <title>Professional Certificate Programmes — ACE</title>
    ...
    <style>
        ...
        .programme-badge { background: rgba(111,66,193,0.12); color: var(--accent); font-weight:600; }
    </style>
</head>
<body>
...
<section class="page-header">
    <div class="container">
        <h1 class="display-5 mb-3">🎓 Professional Certificate Programmes</h1>
        <p class="lead mb-0">Elevate your professional competencies with our accredited certificates recognized by authoritative bodies.</p>
    </div>
</section>
...
<section class="container mt-3">
    <div class="alert alert-info">
        Can't find the Professional Certificate programme you're looking for? <a href="service_inquiry.php?service=certificate" class="alert-link">Request a Certificate Programme</a> and we'll assist you.
</section>
...
<section class="py-5">
    <div class="container">
        ...
        <div class="alert alert-info text-center">
            ...
            No certificate programmes available at the moment. Please check back later.
        </div>
        <?php else: ?>
            ...
            <div class="programme-row d-flex align-items-stretch mb-3 p-0 overflow-hidden">
                ...
                <div class="flex-grow-1 p-4">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            <span class="badge programme-badge mb-2">Certificate</span>
