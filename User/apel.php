...
// Fetch APEL programmes with first image
$stmt = $conn->prepare("SELECT p.programme_id, p.title, p.description, p.start_date, p.end_date, p.location, p.price, p.has_packages,
                        ...
                        FROM programmes p
                        WHERE p.programme_category = 'apel' AND p.is_active = 1 
...
<head>
    ...
    <style>
        ...
        .page-header { background: linear-gradient(135deg, #0d6efd 0%, #0a58ca 100%); color:#fff; padding:48px 0; }
        ...
        .programme-badge { background: rgba(13,110,253,0.12); color: #0d6efd; font-weight:600; }
    </style>
</head>
<body>
...
<section class="page-header">
    <div class="container">
        <h1 class="display-5 mb-3">📚 APEL Programmes</h1>
        <p class="lead mb-0">Accreditation of Prior Experiential Learning — Recognition of your professional experience for academic advancement.</p>
    </div>
</section>
...
<section class="container mt-3">
    <div class="alert alert-info">
        Can't find the APEL programme you need? <a href="service_inquiry.php?service=apel" class="alert-link">Request an APEL Programme</a> and we'll assist you.
    </div>
</section>
...
<section class="py-5">
    <div class="container">
        ...
        <div class="alert alert-info text-center">
            ...
            No APEL programmes available at the moment. Please check back later.
        </div>
        <?php else: ?>
            ...
            <div class="programme-row d-flex align-items-stretch mb-3 p-0 overflow-hidden">
                ...
                <div class="flex-grow-1 p-4">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            <span class="badge programme-badge mb-2">APEL</span>
