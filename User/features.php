...
<head>
    ...
    <style>
        ...
        .page-hero { 
            min-height: 40vh; 
            background-image: url('/User/images/features-bg-.jpg'); 
                ...
                <div id="svcCarousel1" class="carousel slide service-carousel" data-bs-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="/User/images/service1-1.JPG" class="d-block w-100" alt="Self-assessment screenshot 1">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/service1-2.jpg" class="d-block w-100" alt="Self-assessment screenshot 2">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/service1-3.jpg" class="d-block w-100" alt="Self-assessment screenshot 3">
                    </div>
                  </div>
        ...
        <div id="consultancy" class="row align-items-center mb-5 service-row">
            <div class="col-lg-6 service-media">
                <div id="svcCarousel2" class="carousel slide service-carousel" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="/User/images/service2-1.jpeg" class="d-block w-100" alt="Consultancy Programme 1">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/service2-2.jpg" class="d-block w-100" alt="Consultancy Programme 2">
                    </div>
                  </div>
        ...
        <div id="certificate" class="row align-items-center mb-5 service-row">
            <div class="col-lg-6 service-media">
                <div id="svcCarousel3" class="carousel slide service-carousel" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="/User/images/service3-1.jpg" class="d-block w-100" alt="Certificate 1">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/service3-2.jpeg" class="d-block w-100" alt="Certificate 2">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/service3-3.jpeg" class="d-block w-100" alt="Certificate 3">
                    </div>  
                  </div>
        ...
        <div id="specialized" class="row align-items-center mb-5 service-row">
            <div class="col-lg-6 service-media">
                <div id="svcCarousel4" class="carousel slide service-carousel" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="/User/images/service4-1.jpg" class="d-block w-100" alt="Specialized Course dashboard 1">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/service4-2.jpeg" class="d-block w-100" alt="Specialized Course dashboard 2">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/service4-3.jpeg" class="d-block w-100" alt="Specialized Course dashboard 3">
                    </div>
                  </div>
        ...
        <div id="odl" class="row align-items-center mb-5 service-row">
            <div class="col-lg-6 service-media">
                <div id="svcCarousel5" class="carousel slide service-carousel" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="/User/images/service5-1.png" class="d-block w-100" alt="Service 5 image 1">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/service5-2.png" class="d-block w-100" alt="Service 5 image 2">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/service5-3.png" class="d-block w-100" alt="Service 5 image 3">
                    </div>
                  </div>
        ...
        <div id="apel" class="row align-items-center mb-5 service-row">
            <div class="col-lg-6 service-media">
                <div id="svcCarousel7" class="carousel slide service-carousel" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="/User/images/service3-1.jpg" class="d-block w-100" alt="APEL image 1">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/service3-2.jpeg" class="d-block w-100" alt="APEL image 2">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/service3-3.jpeg" class="d-block w-100" alt="APEL image 3">
                    </div>
                  </div>
        ...
        <div id="micro-credential" class="row align-items-center mb-5 service-row">
            <div class="col-lg-6 service-media">
                <div id="svcCarousel6" class="carousel slide service-carousel" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="/User/images/service3-1.jpg" class="d-block w-100" alt="Micro-Credential image 1">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/service3-2.jpeg" class="d-block w-100" alt="Micro-Credential image 2">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/service3-3.jpeg" class="d-block w-100" alt="Micro-Credential image 3">
                    </div>
                  </div>
        ...
        <div id="coe" class="row align-items-center mb-5 service-row">
            <div class="col-lg-6 service-media">
                <div id="svcCarouselCoE" class="carousel slide service-carousel" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="/User/images/coe-1.jpg" class="d-block w-100" alt="CoE 1">
                    </div>
                    <div class="carousel-item">
                      <img src="/User/images/coe-2.jpg" class="d-block w-100" alt="CoE 2">
                    </div>
                  </div>
        ...
        <div id="event-space-rental" class="row align-items-center mb-5 service-row">
            <div class="col-lg-6 service-media">
                <div id="svcCarouselEvent" class="carousel slide service-carousel" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="/User/images/EV-rental.jpeg" class="d-block w-100" alt="Event Space Rental 1">
                    </div>
                  </div>
